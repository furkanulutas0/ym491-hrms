...
\restrict OfKPuK0ubXA4MVjFK0nHz18l8LBHIVazl91on96ZVsOgM0eKzWYDF5XTwIdg9Jo
...
SELECT pg_catalog.setval('public.candidate_additional_info_id_seq', 37, true);
...
SELECT pg_catalog.setval('public.candidate_awards_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.candidate_education_id_seq', 56, true);
...
SELECT pg_catalog.setval('public.candidate_languages_id_seq', 46, true);
...
SELECT pg_catalog.setval('public.candidate_personal_info_id_seq', 37, true);
...
SELECT pg_catalog.setval('public.candidate_project_achievements_id_seq', 28, true);
...
SELECT pg_catalog.setval('public.candidate_projects_id_seq', 60, true);
...
SELECT pg_catalog.setval('public.candidate_raw_data_id_seq', 37, true);
...
SELECT pg_catalog.setval('public.candidate_soft_skills_id_seq', 154, true);
...
SELECT pg_catalog.setval('public.candidate_technical_skills_id_seq', 570, true);
...
SELECT pg_catalog.setval('public.candidate_volunteering_id_seq', 48, true);
...
SELECT pg_catalog.setval('public.candidate_volunteering_responsibilities_id_seq', 104, true);
...
SELECT pg_catalog.setval('public.candidate_work_experience_id_seq', 89, true);
...
SELECT pg_catalog.setval('public.candidate_work_experience_responsibilities_id_seq', 272, true);
...
SELECT pg_catalog.setval('public.candidates_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.job_applications_id_seq', 63, true);
...
SELECT pg_catalog.setval('public.job_posting_activities_id_seq', 218, true);
...
SELECT pg_catalog.setval('public.job_posting_daily_stats_id_seq', 218, true);
...
\unrestrict OfKPuK0ubXA4MVjFK0nHz18l8LBHIVazl91on96ZVsOgM0eKzWYDF5XTwIdg9Jo
