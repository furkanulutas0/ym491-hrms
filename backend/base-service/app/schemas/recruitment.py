...
class JobApplication(JobApplicationBase):
    ...
    exam_finalized_score: Optional[int] = None
...
# --- Exam System Integration Schemas ---

class ExamWebhookEventData(BaseModel):
    """Data payload for exam webhook events"""
...
class ExamWebhookEvent(BaseModel):
    """Webhook event from exam system"""
    event: str  # exam_started, exam_submitted, exam_graded
    timestamp: str
    externalAppId: str  # This is the job application ID
    candidateExamId: str
    candidateName: str
    candidateEmail: str
    data: ExamWebhookEventData

class CreateCandidateExamRequest(BaseModel):
    """Request to create a candidate exam in the exam system"""
    examId: str
    candidateName: str
    candidateEmail: str
    externalAppId: str  # Job application ID
    webhookUrl: str
    webhookSecret: Optional[str] = None
    expiresAt: str  # ISO date string

class CreateCandidateExamResponse(BaseModel):
    """Response from exam system when creating a candidate exam"""
    success: bool
